...
* O primeiro usuário deve ser adicionado manualmente. A senha precisa ser codificada usando bcrypt antes de salvar no arquivo yml. For convenience, we provide CommonUtils to encode the password.
