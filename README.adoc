...
* Não há necessidade de reiniciar o servidor após adicionar um novo usuário ou atualizar as informações do usuário. Timing thread introduced in Step 1 will refresh the user list according to your settings.
